...
public class RequestUtils {
     ...
     * @param observer
     */
    public static void getDemoList(RxActivity context, MyObserverList<List<Demo>> observer){
     ...
     * @param observer
     */
    public static void _getDemoList(RxActivity context, MyObserver<List<Demo>> observer){
        RetrofitUtils.getApiUrl()
                ._getDemoList().compose(RxHelper.observableIO2Main(context))
                .subscribe(observer);
    }
    /**
     * Post 请求demo
